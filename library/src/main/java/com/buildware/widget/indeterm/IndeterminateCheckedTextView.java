 ...
 */
public class IndeterminateCheckedTextView extends AppCompatCheckedTextView
    ...
    public interface OnStateChangedListener {
         ...
         */
        void onStateChanged(IndeterminateCheckedTextView buttonView, @Nullable Boolean state);
    }

    public IndeterminateCheckedTextView(Context context) {
        this(context, null);
    }

    public IndeterminateCheckedTextView(Context context, AttributeSet attrs) {
        super(context, attrs);

        setCheckMarkDrawable(R.drawable.btn_checkmark);
    ...
    public CharSequence getAccessibilityClassName() {
        return IndeterminateCheckedTextView.class.getName();
    }
    ...
    static class SavedState extends BaseSavedState {
        ...
        /**
         * Constructor called from {@link IndeterminateCheckedTextView#onSaveInstanceState()}
         */
        ...
        public String toString() {
            return "IndeterminateCheckedTextView.SavedState{"
